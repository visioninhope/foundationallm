...
{
    public class ContentSourceProfileUpgrade : Upgrade
    {
        public ContentSourceProfileUpgrade(BlobStorageService blobStorageService,
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger = _loggerFactory.CreateLogger<ContentSourceProfileUpgrade>();

            _defaultValues = new Dictionary<string, object>();
        }

        protected ILogger<ContentSourceProfileUpgrade> _logger;
            ...
            foreach (string name in _datasources.Keys)
            {
                ...
                while (agentVersion < TargetInstanceVersion)
                {
                    ...
                    try
                    {
                        ...
                        var upgrader = (ContentSourceProfileUpgrade)Activator.CreateInstance(t, new object[] { _blobStorageService, _instanceSettings, _loggerFactory });
