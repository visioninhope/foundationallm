...
| `vectorization-state/requests/{yyyyMMdd}/{yyyyMMdd-requestid}.json` | Azure storage directory where vectorization requests managed by the vectorization state service are stored. |
