...
from foundationallm.models.metadata import InternalContextAgent as InternalContextMetadata
from foundationallm.models.orchestration import InternalContextCompletionRequest
from foundationallm.models.language_models import LanguageModelType, LanguageModelProvider, LanguageModel
from foundationallm.langchain.language_models import LanguageModelFactory
from foundationallm.langchain.agents import InternalContextAgent
...
def test_internal_context_completion_request():
     req = InternalContextCompletionRequest(
         user_prompt=""" 
         ...
         """,
         agent=InternalContextMetadata(
            name="random-trivia-agent",
...
class InternalContextAgentTests:
    def test_internal_context_agent_initializes(self, test_llm,  test_config, test_internal_context_completion_request, test_resource_provider):        
        agent = InternalContextAgent(completion_request=test_internal_context_completion_request, llm=test_llm, config=test_config, resource_provider=test_resource_provider)
