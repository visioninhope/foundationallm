...
{
    public class DatasourceUpgrade : Upgrade
    {
        public DatasourceUpgrade(BlobStorageService blobStorageService,
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger = _loggerFactory.CreateLogger<DatasourceUpgrade>();

            _defaultValues = new Dictionary<string, object>();
        }

        protected ILogger<DatasourceUpgrade> _logger;
        ...
        public virtual async Task<Dictionary<string, string>> LoadAgents()
        {
            var fileContent = await _blobStorageService.ReadFileAsync("resource-provider", "FoundationaLLM.DataSource/_data-source-references.json");
