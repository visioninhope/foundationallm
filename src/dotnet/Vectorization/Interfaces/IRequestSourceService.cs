...
namespace FoundationaLLM.Vectorization.Interfaces
{
    ...
    public interface IRequestSourceService
    {
        ...
        /// <returns>A collection of tuples containg a <see cref="VectorizationRequest"/> object and a string receipt.
        /// The receipt will be used to delete the message from the request source after it has been processed.</returns>
        Task<IEnumerable<(VectorizationRequest Request, string PopReceipt)>> ReceiveRequests(int count);
