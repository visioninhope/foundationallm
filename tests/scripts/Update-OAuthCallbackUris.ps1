...
Param(
    [parameter(Mandatory = $false)][string]$fllmChatUiName = "FoundationaLLM-E2E-Client", # FLLM Chat UI
    [parameter(Mandatory = $false)][string]$fllmMgmtUiName = "FoundationaLLM-Management-E2E-Client" # FLLM Management UI
)
