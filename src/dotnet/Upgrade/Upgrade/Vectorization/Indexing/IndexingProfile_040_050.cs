...
{
    public class IndexingProfile_040_050 : ContentSourceProfileUpgrade
    {
        public IndexingProfile_040_050(BlobStorageService blobStorageService,
            InstanceSettings settings,
            ILoggerFactory loggerFactory) : base(blobStorageService, settings, loggerFactory)
        {
            _blobStorageService = blobStorageService;
            _logger = loggerFactory.CreateLogger<IndexingProfile_040_050>();
            ...
            TargetType = typeof(IndexingProfile050);
        }

        private ILogger<IndexingProfile_040_050> _logger;
        ...
        public async override Task<object> UpgradeDoWorkAsync(object in_agent)
        {
            ...
            IndexingProfile050 target = JsonSerializer.Deserialize<IndexingProfile050>(strAgent);
