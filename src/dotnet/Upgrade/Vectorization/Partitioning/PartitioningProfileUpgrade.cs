...
{
    public class PartitioningProfileUpgrade : Upgrade
    {
        public PartitioningProfileUpgrade(BlobStorageService blobStorageService,
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _logger = _loggerFactory.CreateLogger<PartitioningProfileUpgrade>();

            _defaultValues = new Dictionary<string, object>();
        }

        protected ILogger<PartitioningProfileUpgrade> _logger;
            ...
            foreach (string name in _datasources.Keys)
            {
                ...
                while (agentVersion < TargetInstanceVersion)
                {
                    ...
                    try
                    {
                        ...
                        var upgrader = (PartitioningProfileUpgrade)Activator.CreateInstance(t, new object[] { _blobStorageService, _instanceSettings, _loggerFactory });
