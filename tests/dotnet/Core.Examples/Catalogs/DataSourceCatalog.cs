...
namespace FoundationaLLM.Core.Examples.Catalogs
{
    public static class DataSourceCatalog
    {
        ...
        [          
            ...
            new OneLakeDataSource { Name = "onelake_fllm", DisplayName = "onelake_fllm", ConfigurationReferences = new Dictionary<string, string> { { "AuthenticationType", "FoundationaLLM:DataSources:onelake_fllm:AuthenticationType" }, { "AccountName", "FoundationaLLM:DataSources:onelake_fllm:AccountName" } }, Workspaces = new List<string> { "FoundationaLLM" } },
