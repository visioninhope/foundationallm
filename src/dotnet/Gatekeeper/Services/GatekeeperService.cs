...
namespace FoundationaLLM.Gatekeeper.Core.Services
{
    ...
    /// <param name="guardrailsService">The Encrypt AI Guardrails service.</param>
        ...
        IOptions<GatekeeperServiceSettings> gatekeeperServiceSettings) : IGatekeeperService
    {
        ...
        private readonly IGuardrailsService _guardrailsService = guardrailsService;
        ...
        public async Task<CompletionResponse> GetCompletion(CompletionRequest completionRequest)
        {
            ...
            if (_gatekeeperServiceSettings.EnableEncryptAIGuardrails)
            {
