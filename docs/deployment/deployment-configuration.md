...
`foundationallm-gatekeeper-api-orchestration-api-url` |  | Environment variable | Gatekeeper API |  | The URL of the Agent Factory API used by the Gatekeeper API.
`foundationallm-orchestration-api-keyvault-name` |  | Environment variable | Agent Factory API |  | The name of the Azure Key Vault used by the Agent Factory API.
`foundationallm-orchestration-api-key` |  | Key Vault secret| Agent Factory API |  | The first Agent Factory API key.
`foundationallm-orchestration-api-agenthub-api-url` |  | Environment variable | Agent Factory API |  | The URL of the Agent Hub API used by the Agent Factory API.
`foundationallm-orchestration-api-prompthub-api-url` |  | Environment variable | Agent Factory API |  | The URL of the Prompt Hub API used by the Agent Factory API.
`foundationallm-orchestration-api-datasourcehub-api-url` |  | Environment variable | Agent Factory API |  | The URL of the Data Source Hub API used by the Agent Factory API.
`foundationallm-orchestration-api-langchain-api-url` |  | Environment variable | Agent Factory API |  | The URL of the LangChain API used by the Agent Factory API.
`foundationallm-orchestration-api-semantickernel-api-url` |  | Environment variable | Agent Factory API |  | The URL of the Semantic Kernel API used by the Agent Factory API.
