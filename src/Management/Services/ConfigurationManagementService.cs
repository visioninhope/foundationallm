    ...
    public class ConfigurationManagementService : IConfigurationManagementService
    {
        ...
        public async Task SetBrandingConfiguration(ClientBrandingConfiguration brandingConfiguration)
        {
            try
            {
                ...
                {
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_AccentColor,
                        brandingConfiguration.AccentColor),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_BackgroundColor,
                        brandingConfiguration.BackgroundColor),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_CompanyName,
                        brandingConfiguration.CompanyName),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_FavIconUrl,
                        brandingConfiguration.FavIconUrl),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_KioskMode,
                        brandingConfiguration.KioskMode.ToString()),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_LogoText,
                        brandingConfiguration.LogoText),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_LogoUrl,
                        brandingConfiguration.LogoUrl),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_PageTitle,
                        brandingConfiguration.PageTitle),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_PrimaryColor,
                        brandingConfiguration.PrimaryColor),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_PrimaryTextColor,
                        brandingConfiguration.PrimaryTextColor),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_SecondaryColor,
                        brandingConfiguration.SecondaryColor),
                    new ConfigurationSetting(AppConfigurationKeys.FoundationaLLM_Branding_SecondaryTextColor,
