...
{
    /// <summary>
    /// Validator for the <see cref="BatchActionAuthorizationRequest"/> model.
    /// </summary>
    public class BatchActionAuthorizationRequestValidator : AbstractValidator<BatchActionAuthorizationRequest>
    {
        /// <summary>
        /// Configures the validation rules for the <see cref="BatchActionAuthorizationRequest"/> model.
        /// </summary>
        public BatchActionAuthorizationRequestValidator()
        {
