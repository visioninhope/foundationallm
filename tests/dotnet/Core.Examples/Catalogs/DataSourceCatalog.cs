...
namespace FoundationaLLM.Core.Examples.Catalogs
{
    public static class DataSourceCatalog
    {
        ...
        [          
            ...
            new AzureDataLakeDataSource 
            { 
                Name = "datalake_vectorization_input", 
                DisplayName = "datalake_vectorization_input", 
                ConfigurationReferences = new Dictionary<string, string> 
                { 
                    { "AuthenticationType", "FoundationaLLM:DataSources:datalake_vectorization_input:AuthenticationType" }, 
                    { "AccountName", "FoundationaLLM:DataSources:datalake_vectorization_input:AccountName" } 
                }, 
                Folders = ["vectorization-input"] 
            },
            new AzureDataLakeDataSource
            {
                Name = "sdzwa_datalake_vectorization_input",
                DisplayName = "sdzwa_datalake_vectorization_input",
                ConfigurationReferences = new Dictionary<string, string>
                {
                    { "AuthenticationType", "FoundationaLLM:DataSources:sdzwa_datalake_vectorization_input:AuthenticationType" },
                    { "AccountName", "FoundationaLLM:DataSources:sdzwa_datalake_vectorization_input:AccountName" }
                },
                Folders = ["vectorization-input"]
            }
        ];
