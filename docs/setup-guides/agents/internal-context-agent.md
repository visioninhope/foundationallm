...
- (Optional) `<prompt_resource_objectid>` is the object ID of the prompt resource, if one exists.
...
| `prompt_object_id` | (Optional) The object ID of the prompt resource, if one exists. |
